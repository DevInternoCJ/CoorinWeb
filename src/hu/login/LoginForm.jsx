...
const LoginForm = () => {
  ...
  const handleSubmit = async (e) => { // <--- Convertir a async
    ...
    const userData = {
      ...
      // Asegúrate de enviar los siguientes campos si tu API los requiere,
      // de lo contrario, puedes omitirlos o dejarlos en null si el backend los ignora.
      extension: null,
      bloqueo: null,
      dominio: null,
      computadora: null,
      usuarioWindows: null,
      ip: null, // Puedes intentar obtener la IP del cliente en el frontend, pero es más fiable que el backend la capture.
      aplicacion: "GESPAWEB_FRONT", // Un identificador de tu aplicación
      version: "1.0.0", // La versión actual de tu frontend
      piso: null,
      servidor: null,
    };
