...
const ModalCampanasCampanias = () => {
  ...
  const cargarCampanas = () => {
    ...
    const idEncargado =
      userData?.idEjecutivo ?? userData?.idejecutivo ?? userData?.id ?? 1;
    const idCartera =
      userData?.idCartera ?? userData?.idcartera ?? userData?.cartera ?? 1;
    const idProducto =
  ...
  return (
    ...
    >
      ...
      <ModalFilasCampañas
        ...
        onClose={() =>
          setModalFilas({ open: false, cartera: "American Express" })
        }
