    ...
    return (
        <div className="flex items-center mb-2 w-full gap-4">
            ...
            <div className="flex items-center gap-2">
                ...
                <h2 className="modal-title">Campañas - Coorinnn</h2>
            </div>
            {/* Elementos centrados: logo y dropdowns */}
            ...
            {/* Botón de cerrar completamente a la derecha */}
            <button
                onClick={onClose}
                className="modal-btn modal-btn-close ml-auto"
                aria-label="Cerrar"
                style={{ fontSize: '2rem' }}
            >
                &times;
