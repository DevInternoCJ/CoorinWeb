...
const OffersContent = () => {
    ...
    const [footerMsg, setFooterMsg] = useState("Elija la consulta de las cuentas que desee el ofrecimiento y el periodo.");
        ...
        const handleDownloadExcel = async () => {
            ...
            try {
                ...
                if (response && response.data instanceof Blob) {
                    ...
                    a.href = url;
                    a.download = `ofrecimiento${desde}_a_${hasta}.csv`;
                ...
                setErrorExcel('Error al obtener las ofrecimiento.',err);
                setFooterMsg("Ocurrió un error al guardar el libro de Excel.");
            } finally {
