...
const MODAL_SIZES = {
    ...
    consultaVisits: { maxWidth: "min(800px, 95vw)", minWidth: "320px", width: 'auto', height: 'auto', maxHeight: "90vh" },
    capturaVisit: { maxWidth: "min(805px, 95vw)", minWidth: "320px", width: 'auto', height: 'auto', maxHeight: "90vh" },
    "capturaVisit-expanded": { maxWidth: "min(805px, 95vw)", minWidth: "320px", width: "min(370px, 95vw)", height: "380px", maxHeight: "90vh" },
    cargaVisitas: { maxWidth: "min(1100px, 95vw)", minWidth: "320px", width: 'auto', height: 'auto', maxHeight: "95vh" },
