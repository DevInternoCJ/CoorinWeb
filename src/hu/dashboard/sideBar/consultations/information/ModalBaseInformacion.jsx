...
const ModalBaseInformacion = ({
  ...
  useEffect(() => {
    if (activeTab !== 1) {
      // Solo mostrar tabla en el tab Carga (índice 1)
      setMostrarTabla("");
    }
  ...
  else if (isCapturaVisitas)
    normalizedSize = size === "pagos-xl" ? "informacion-xl" : "capturaVisit";
  ...
  if (carouselNav) {
    console.log(
      "[ModalBaseInformacion] Tab activo:",
      tabsListInformacion[carouselNav.currentIndex]?.key,
    );
  ...
  useEffect(() => {
    try {
      window.dispatchEvent(
        new CustomEvent("coorin-modal-open", { detail: { open: true } }),
      );
    } catch (err) {
      console.warn("dispatch open failed", err);
    }
    return () => {
      try {
        window.dispatchEvent(
          new CustomEvent("coorin-modal-open", {
            detail: { open: false, byClose: false },
          }),
        );
      } catch (err) {
        console.warn("dispatch close failed", err);
      }
    };
  }, []);
            ...
            <>
              ...
              <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3 bg-gray-50">
                ...
                <div className="flex-1 min-w-0 flex justify-center">
                  <h2 className="text-lg font-semibold truncate text-jerarquia3">
                    Información
                  </h2>
                </div>
          ...
          {isInformacion ? (
                  ...
                  <div className="p-1 md:p-4">
                    <h3 className="text-sm font-semibold text-jerarquia3 mb-1.5 md:mb-3 uppercase tracking-wide flex items-center justify-center">
                      ...
                      >
                        <path
                          fill="currentColor"
                          d="M4.01 8.54C5.2 9.23 6 10.52 6 12s-.81 2.77-2 3.46V18h16v-2.54c-1.19-.69-2-1.99-2-3.46s.81-2.77 2-3.46V6H4zm6.72 1.68L12 7l1.26 3.23l3.47.2l-2.69 2.2l.89 3.37L12 14.12L9.07 16l.88-3.37l-2.69-2.2z"
                          opacity="0.3"
                        />
                        <path
                          fill="currentColor"
                          d="M20 4H4c-1.1 0-1.99.9-1.99 2v4c1.1 0 1.99.9 1.99 2s-.89 2-2 2v4c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-4c-1.1 0-2-.9-2-2s.9-2 2-2V6c0-1.1-.9-2-2-2m0 4.54c-1.19.69-2 1.99-2 3.46s.81 2.77 2 3.46V18H4v-2.54c1.19-.69 2-1.99 2-3.46c0-1.48-.8-2.77-1.99-3.46L4 6h16zM9.07 16L12 14.12L14.93 16l-.89-3.36l2.69-2.2l-3.47-.21L12 7l-1.27 3.22l-3.47.21l2.69 2.2z"
                        />
                      </svg>
                    ...
                    >
                      {tabsListAccionamientos.map((tab, index) => (
                        ...
                        >
                          <span
                            className={`${activeTab === index ? "text-jerarquia3" : "text-gray-500"} flex-shrink-0 scale-75 md:scale-100`}
                          >
            ...
            <div className="flex flex-col">
              ...
              <div className="flex">
                {/* Columna izquierda: tabs verticales */}
                <div
                  className={`w-16 md:w-64 flex-shrink-0 border-r border-gray-200 bg-gray-50 overflow-auto h-fit ${activeTab === 2 || activeTab === 3 || activeTab === 4 ? "pt-12" : ""}`}
                >
                  <div className="p-1 md:p-4">
                    <h3 className="text-sm font-semibold text-jerarquia3 mb-1.5 md:mb-3 uppercase tracking-wide flex items-center justify-center">
                      <svg
                      ...
                      >
                        <path
                          fill="currentColor"
                          d="M20 6h-8l-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2m-2.06 11L15 15.28L12.06 17l.78-3.33l-2.59-2.24l3.41-.29L15 8l1.34 3.14l3.41.29l-2.59 2.24z"
                        />
                      </svg>
