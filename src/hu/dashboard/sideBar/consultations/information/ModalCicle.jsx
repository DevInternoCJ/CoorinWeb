...
const ModalCicle = ({ tabsList = tabsListInformacion, componentIcons = COMPONENT_ICONS_INFORMACION, mostrarTabla, setMostrarTabla, onNavigationReady, onSizeChange, headerControlsActive = false, headerStates = {}, activeTab: externalActiveTab, setActiveTab: externalSetActiveTab }) => {
    ...
    useEffect(() => {
        const needsXL = mostrarTablaReporting || mostrarTablaWrongs || mostrarTablaAddresses || mostrarTablaEmails || regrestExpanded;
        if (onSizeChange) {
            onSizeChange(needsXL ? "informacion-xl" : "informacion");
        }
    }, [mostrarTablaReporting, mostrarTablaWrongs, mostrarTablaAddresses, mostrarTablaEmails, regrestExpanded, onSizeChange]);
