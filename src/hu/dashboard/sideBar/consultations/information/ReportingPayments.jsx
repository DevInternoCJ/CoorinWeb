...
const ReportingPaymentsContent = ({ mostrarTabla, setMostrarTabla }) => {
    ...
    const handleExportar = () => {
        ...
        exportDataToCSV(tablaData, `pagos_reportados_${desde}_a_${hasta}`, {
    ...
    <div style={{ width: '100%', height: '100%' }} className="flex flex-col items-center">
            ...
            {!mostrarTabla && (
                <>
                    ...
                    <div
                        ...
                        style={{ flex: 1, transition: 'margin-top 0.2s' }}
                    >
                        <div className="flex gap-3 w-full max-w-sm justify-center" style={{ marginBottom: '1.2rem' }}>
            ...
            {mostrarTabla && (
                <div className="flex flex-col w-full" style={{ flex: 1, minHeight: 0 }}>
                    {/* Grid responsivo: lg=5cols | md=3cols+botones abajo | sm=1col apilado */}
                    <div className="w-full mb-4">
                        {/* Fila de campos: lg=5cols (con botones), md=3cols, sm=1col */}
                    ...
                    <div style={{ width: '100%', flex: 1, minHeight: 0, borderRadius: 8, border: '1px solid #e0e0e0', background: '#fff', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
