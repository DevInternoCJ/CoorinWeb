                        ...
                        <table className="modal-table" style={{width: '100%', borderCollapse: 'collapse'}}>
                            <thead>
                                <tr>
                                    ...
                                    <th style={{ whiteSpace: 'nowrap', position: 'sticky', top: 0, zIndex: 10 }}>Cartera</th>
                                    ...
                                    <th style={{ whiteSpace: 'nowrap', position: 'sticky', top: 0, zIndex: 10 }}>NombreEjecutivo</th>
                                    <th style={{ whiteSpace: 'nowrap', position: 'sticky', top: 0, zIndex: 10 }}>ClaveEjecutivo</th>
                                </tr>
                            </thead>
                            <tbody>
                                {!hasBuscado ? (
