    ...
    return (
        <div className="p-6 md:pt-20 flex flex-col h-full space-y-4 sm:space-y-8">
            ...
            <div className="w-full flex items-center justify-center gap-3 -mt-6">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="w-6 h-6 text-jerarquia3">
                ...
                <h2 className="text-xl font-semibold text-jerarquia3">Consulta Complemento</h2>
            </div>
