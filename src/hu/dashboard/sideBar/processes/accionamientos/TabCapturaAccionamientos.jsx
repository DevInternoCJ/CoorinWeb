...
const CapturaContent = () => {
    ...
    return (
        <div className="p-6 flex flex-col h-full space-y-4">
            ...
            {/* Row 3: Calendarios Envío y Devuelto a la izquierda, Botón Captura y Select Causa Devolución al final */}
            <div className="flex gap-4 items-end">
                ...
                <div className="flex gap-4 flex-1 items-end">
                    ...
                    <button
                        ...
                        className="px-4 py-2 text-sm font-medium rounded-lg transition-colors bg-jerarquia1 text-white cursor-pointer hover:bg-jerarquia2"
                    >
                        Captura
                    </button>
                </div>
