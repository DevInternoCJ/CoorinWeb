  ...
  return (
    <>
      {dataDash.map((catalog) => (
        <div
          className="card card-sm sm:max-w-sm rounded-2xl p-1 xl:max-w-none transition-all duration-200 ease-in-out hover:scale-105 group relative overflow-visible animated-border cursor-pointer"
          key={catalog.id}
          ...
          <div className="pointer-events-none absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-15 transition-opacity duration-100 bg-black"></div>
          ...
          <div className="card-footer text-center">
            <p className="text-base-content group-hover:text-black transition-colors duration-200">
              Abrir
            </p>
          </div>
        </div>
