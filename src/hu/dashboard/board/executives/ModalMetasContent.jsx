...
const ModalMetasContent = () => {
  ...
  const handleExecutiveClick = (node) => {
    ...
    if (node.idEjecutivo === Number(idEjecutivoSesion)) {
      if (Array.isArray(node.subordinados) && node.subordinados.length > 0) {
        const idsSubordinados = node.subordinados
      ...
      const idsSubSub = node.subordinados
        .map((sub) => sub.idEjecutivo)
        .filter(Boolean);
  ...
  useEffect(() => {
    ...
    if (validIds.length > 0) {
      console.log(
        "🟢 Ids enviados a obetenerTablaMetas:",
        validIds,
      ...
      console.log(
        "⚠️ No se enviaron ids válidos a obetenerTablaMetas. selectedExecutives:",
        selectedExecutives
      );
    }
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col gap-3" style={{ minWidth: 0 }}>
        {/* Fila de inputs */}
        <div
          className="bg-white rounded-lg p-3 shadow border border-[var(--color-jerarquia1)]"
          ...
          >
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setInputValues((v) => ({ ...v, cuentas: e.target.value }))
                }
                style={{
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setInputValues((v) => ({ ...v, titulares: e.target.value }))
                }
                style={{
                  backgroundColor: "var(--color-bgcolor2)",
                  color: "var(--color-jerarquia3)",
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setInputValues((v) => ({
                    ...v,
                    saldoSolucionado: e.target.value,
                  }))
                }
                style={{
                  backgroundColor: "var(--color-bgcolor2)",
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setInputValues((v) => ({ ...v, segmento: e.target.value }))
                }
                style={{
                  backgroundColor: "var(--color-bgcolor2)",
                  color: "var(--color-jerarquia3)",
              ...
              <div style={{ position: "relative", width: "100%" }}>
                <input
                  ...
                  onChange={(e) =>
                    setInputValues((v) => ({
                      ...v,
                      horaSalida: e.target.value === "" ? null : e.target.value,
                    }))
                  }
                  style={{
                    backgroundColor: "var(--color-bgcolor2)",
        ...
        {/* Tabla principal */}
        <div
          className="bg-white rounded-lg p-3 shadow border border-[var(--color-jerarquia1)] flex-1 flex flex-col"
                ...
                {!loading &&
                  ...
                  tablaMetas
                    ...
                    .map((row, i) => {
                      ...
                      const safe = (val, def = "") =>
                        val !== null && val !== undefined ? val : def;
                      return (
                        <tr
                          key={rowKey}
                          className={
                            selectedRows.includes(rowKey) ? "row-selected" : ""
                          }
                        ...
                        >
                          ...
                          <td>
                            <input
                              ...
                              min={0}
                              value={safe(
                                editValues[rowKey]?.negociaciones,
                                safe(
                                  row.negociaciones,
                                  safe(row.totalNegociaciones, 0)
                                )
                              )}
                              onChange={(e) =>
                                setEditValues((v) => ({
                          ...
                          <td>
                            <input
                              ...
                              min={0}
                              value={safe(
                                editValues[rowKey]?.cumplimientos,
                                safe(
                                  row.cumplimientos,
                                  safe(row.totalCumplimientos, 0)
                                )
                              )}
                              onChange={(e) =>
                                setEditValues((v) => ({
                          ...
                          <td>
                            <input
                              ...
                              step={0.01}
                              value={safe(
                                editValues[rowKey]?.montoCumplido,
                                safe(
                                  editValues[rowKey]?.monto_cumplido,
                                  safe(
                                    row.montoCumplido,
                                    safe(row.monto_cumplido, 0)
                                  )
                                )
                              )}
                              onChange={(e) =>
                          ...
                          <td>
                            <input
                              ...
                              step={0.01}
                              value={safe(
                                editValues[rowKey]?.saldoSolucionado,
                                safe(
                                  editValues[rowKey]?.saldo_solucionado,
                                  safe(
                                    row.saldoSolucionado,
                                    safe(row.saldo_solucionado, 0)
                                  )
                                )
                              )}
                              onChange={(e) =>
                          ...
                          <td>
                            <input
                              type="time"
                              value={
                                editValues[rowKey]?.horaEntrada === null
                                  ? ""
                                  : safe(
                                      editValues[rowKey]?.horaEntrada,
                                      safe(
                                        row.horaEntrada,
                                        safe(row.hora_entrada, "")
                                      )
                                    )
                              }
                              onChange={(e) =>
                          ...
                          <td>
                            <input
                              type="time"
                              value={
                                editValues[rowKey]?.horaSalida === null
                                  ? ""
                                  : safe(
                                      editValues[rowKey]?.horaSalida,
                                      safe(
                                        row.horaSalida,
                                        safe(row.hora_salida, "")
                                      )
                                    )
                              }
                              onChange={(e) =>
