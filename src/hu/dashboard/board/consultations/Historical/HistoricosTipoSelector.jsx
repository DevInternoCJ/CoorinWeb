...
const HistoricosTipoSelector = ({ cartera, setCartera, carteras, carterasProductosData, setProductos, setProducto, isIndividual, setTipoSeleccionado, handleTipoSeleccion }) => (
