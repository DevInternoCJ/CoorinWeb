...
const ModalConsultaEjecutivosModal = ({ isOpen, onClose }) => {
    ...
    return (
        <ReusableModal
            ...
            closeOnEscape={false}
        >
            <div className="coorin-modal-xl-container" style={{ maxWidth: "98vw", overflowX: "auto" }}>
                {/* Header y formulario */}
                    ...
                    {loading && (
                        <div className="absolute inset-0 flex items-center justify-center" style={{ background: 'rgba(255,255,255,0.6)', zIndex: 90 }}>
                            <div className="flex flex-col items-center">
                                <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-jerarquia1" style={{ borderRightColor: 'transparent' }}></div>
                            ...
                            <tr>
                                {resultados && resultados.length > 0 ? (
                                    ...
                                    <>
                                        ...
                                        <th className="whitespace-nowrap" style={{ position: 'sticky', top: 0, left: 240, zIndex: 60, background: 'var(--color-background-secondary)', color: '#fff', fontWeight: 600, minWidth: '40px' }}>Ejecutivo</th>
