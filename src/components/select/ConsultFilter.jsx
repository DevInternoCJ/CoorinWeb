...
const ConsultFilter = ({ 
    ...
    try {
      switch (filterValue) {
        ...
        case "Cuenta": { // Cuenta
          ...
          if (catalogDataCuenta && catalogDataCuenta.catalogosConsultas && Array.isArray(catalogDataCuenta.catalogosConsultas)) {
        ...
        case "Conteos": { // Conteos
          ...
          if (catalogDataConteos && catalogDataConteos.catalogosConsultas && Array.isArray(catalogDataConteos.catalogosConsultas)) {
  ...
  const handleChange = (e) => {
    ...
    if (onSelectionChange) {
      const selectedOption = dynamicOptions.find(option => option.value === value);
