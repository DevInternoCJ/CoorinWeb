      ...
      {subMenus.map((item, idx) => {
            ...
            <li key={id} id={id}>
              <a
                className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm
                           text-[var(--color-text-secondary)] rounded-lg
        ...
        return (
          <li className="hs-accordion" id={id} key={id}>
            <button
              type="button"
              className="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm
                         text-[var(--color-text-secondary)] rounded-lg
            ...
            >
              ...
              {/* Toggle icons */}
              <svg
                className="hs-accordion-active:block ml-auto hidden w-4 h-4 text-[var(--color-text-muted)] group-hover:text-[var(--color-text-secondary)]"
              ...
              <svg
                className="hs-accordion-active:hidden ml-auto block w-4 h-4 text-[var(--color-text-muted)] group-hover:text-[var(--color-text-secondary)]"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
      ...
      >
        <div className="flex flex-col h-full max-h-full">
            ...
            <div className="lg:hidden">
              <button
                ...
                className="flex justify-center items-center w-8 h-8
                           text-[var(--color-text-muted)] rounded-full
                          ...
                          <li id={menuId} key={menuId}>
                            {menu.id === "4CC" ? (
                              ...
                              >
                                ...
                                <span className="inline-block font-semibold text-sm text-[var(--color-text-primary)]">
          ...
          <footer className="mt-auto p-2 border-t border-[var(--color-border)] bg-[var(--color-surface)] transition-colors duration-300">
            <div className="flex items-center justify-between gap-2 hs-overlay-minified:justify-center">
              <div className="flex-1 hs-overlay-minified:hidden">
                <Logout />
              </div>
