        ...
        <div className="p-6 flex flex-col h-full space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="relative w-full">
                    ...
                    {loadingConsultas && <p className="text-sm text-gray-500 mt-1">Cargando consultas...</p>}
                    {errorConsultas && <p className="text-sm text-red-500 mt-1">Error al cargar consultas</p>}
                </div>
            </div>
