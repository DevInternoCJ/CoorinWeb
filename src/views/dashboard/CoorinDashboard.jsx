...
const Comments = lazy(() => import("../../views/dashboard/sideBar/gespa/comment/Comments"));
            ...
            <div className="w-full px-0 lg:px-8 pt-0">
              <div className="flex justify-between items-center mb-0 mt-0 p-0">
                ...
                <div className="flex items-center relative">
                  <span
                    className="text-4xl font-medium tracking-[-0.02em] flex items-center gap-3 relative transition-colors duration-300"
                    style={{
                      color: isDark ? "#a7f3d0" : "#000000",
                      background: isDark
                        ? "linear-gradient(90deg, rgba(15,31,24,0) 0%, rgba(15,31,24,0.4) 20%, rgba(15,31,24,0.85) 40%, #0f1f18 60%, #111e17 100%)"
                  ...
                  >
                    Coorin
                    <img
                      src={isDark ? ConsorcioLogo : ConsorcioLogo}
                      alt="Coorin"
                      style={{
                        height: "48px",
                        width: "48px",
                        objectFit: "contain",
                        filter: isDark ? "brightness(0) invert(1) sepia(1) saturate(2) hue-rotate(95deg) brightness(0.85)" : "none",
