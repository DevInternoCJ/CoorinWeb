...
{
	public class BusquedasInfoService : IBusquedasInfoService
	{
		private readonly IBusquedasInfoDAO _dao;
		private readonly IQueryGeneratorService _queryGenerator;

		public BusquedasInfoService(IBusquedasInfoDAO dao, IQueryGeneratorService queryGenerator)
		{
			_dao = dao;
