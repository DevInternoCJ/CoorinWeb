...
namespace Loki.Mark.Administracion.Gespa.CamposPantalla.Controllers
{
	...
	public class CamposPantallaController : ControllerBase
	{
		...
		[SwaggerOperation(
			Summary = "Verificar existencia de tabla de producto - Yoshi",
		...
		[SwaggerOperation(
			Summary = "Obtener Campos Pantalla - Yoshi",
		...
		[SwaggerOperation(
			Summary = "Muestra Campos Pantalla - Yoshi",
		...
		[SwaggerOperation(
			Summary = "Grid de Producto - Yoshi",
		...
		[HttpPost("guardar")]
		[SwaggerOperation(
			Summary = "Guardar Campos Pantalla - Yoshi",
