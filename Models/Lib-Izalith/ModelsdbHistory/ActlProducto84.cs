...
public partial class ActlProducto84
{
    ...
    public string? SaldoaNegociar3M { get; set; }

    public string? SaldoaNegociar12M { get; set; }

    public string? SaldoaNegociarPt { get; set; }

    public string? DescuentoPt { get; set; }

    public string? SaldoaNegociarCp { get; set; }

    public string? DescuentoCp { get; set; }

    public string? SaldoaNegociarLp { get; set; }

    public string? DescuentoLp { get; set; }
