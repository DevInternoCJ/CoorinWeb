...
public partial class DbMemoryContextIzalith : DbContext
{
    public DbMemoryContextIzalith()
    {
    }

    public DbMemoryContextIzalith(DbContextOptions<DbMemoryContextIzalith> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<FilasTemp9> FilasTemp9s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=201.98.30.227\\WEBINSTANCE2; database=dbMemory; uid=login_ejecutor; pwd=3j3123/*-; encrypt=true;trustservercertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdFilaDeTrabajo).HasName("PK__FilasDeT__87EEFA0A76BB04BC");
        ...
        modelBuilder.Entity<FilasTemp9>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("FilasTemp_9", "AMS")
                .IsMemoryOptimized();

            entity.HasIndex(e => e.IdCuenta, "IX_FilasCuenta_9");
        ...
        modelBuilder.Entity<GruposDeTrabajo>(entity =>
        {
            entity.HasKey(e => new { e.IdCampaña, e.IdEjecutivo })
                .HasName("PK__GruposDe__A423DC15F908CC0B")
                .IsClustered(false);
        ...
        {
            entity.HasKey(e => new { e.IdEjecutivo, e.Hora }).HasName("PK__Producti__6731E36690F9659F");
        ...
        {
            entity.HasKey(e => e.IdEjecutivo).HasName("PK__Sesiones__01E10275A9D9E8E4");
