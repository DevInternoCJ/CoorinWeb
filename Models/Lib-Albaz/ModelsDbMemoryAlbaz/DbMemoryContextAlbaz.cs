...
using Loki.AlbazLibrary.Memory;
using Microsoft.EntityFrameworkCore;

namespace Loki.AlbazLibrary;

public partial class DbMemoryContextAlbaz : DbContext
{
    public DbMemoryContextAlbaz()
    {
    }

    public DbMemoryContextAlbaz(DbContextOptions<DbMemoryContextAlbaz> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=192.168.7.97\\WEBINSTANCE5;Database=dbMemory;User Id=login_Collection_App;Password=Specialized2016/;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdFilaDeTrabajo).HasName("PK__FilasDeT__87EEFA0A1DF5D8D1");
        ...
        modelBuilder.Entity<GruposDeTrabajo>(entity =>
        {
            entity.HasKey(e => new { e.IdCampaña, e.IdEjecutivo })
                .HasName("PK__GruposDe__A423DC1502F149D8")
                .IsClustered(false);
        ...
        {
            entity.HasKey(e => new { e.IdEjecutivo, e.Hora }).HasName("PK__Producti__6731E3666E93A45E");
        ...
        {
            entity.HasKey(e => e.IdEjecutivo).HasName("PK__Sesiones__01E10275E175D9C2");
