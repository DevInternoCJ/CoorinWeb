...
using Loki.AlbazLibrary.History;
using Microsoft.EntityFrameworkCore;

namespace Loki.AlbazLibrary;

public partial class DbHistoryContextAlbaz : DbContext
{
    public DbHistoryContextAlbaz()
    {
    }

    public DbHistoryContextAlbaz(DbContextOptions<DbHistoryContextAlbaz> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<GesFaltantesArchivoAuditorium> GesFaltantesArchivoAuditoria { get; set; }

    public virtual DbSet<GesFaltantesSistema> GesFaltantesSistemas { get; set; }

    public virtual DbSet<GestionesAuditoriaAnt> GestionesAuditoriaAnts { get; set; }

    public virtual DbSet<GestionesAuditorium> GestionesAuditoria { get; set; }

    public virtual DbSet<GestionesAuditorium1> GestionesAuditoria1 { get; set; }
    ...
    public virtual DbSet<GestionesSistema1> GestionesSistema1s { get; set; }
    ...
    public virtual DbSet<InsertPlazosRespaldo> InsertPlazosRespaldos { get; set; }
    ...
    public virtual DbSet<ProductividadAmex> ProductividadAmexes { get; set; }

    public virtual DbSet<Producto> Productos { get; set; }

    public virtual DbSet<Prueba> Pruebas { get; set; }

    public virtual DbSet<Prueba200> Prueba200s { get; set; }
    ...
    public virtual DbSet<San200> San200s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=192.168.7.97\\WEBINSTANCE5;Database=dbHistory;User Id=login_Collection_App;Password=Specialized2016/;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<GesFaltantesArchivoAuditorium>(entity =>
        {
            entity.HasNoKey();
        ...
        modelBuilder.Entity<GesFaltantesSistema>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("GesFaltantesSistema");
        ...
        modelBuilder.Entity<GestionesAuditoriaAnt>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("GestionesAuditoriaAnt");
        ...
        modelBuilder.Entity<GestionesAuditorium>(entity =>
        {
            entity.HasNoKey();
        ...
        modelBuilder.Entity<GestionesAuditorium1>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("GestionesAuditoria_");
        ...
        modelBuilder.Entity<GestionesSistema1>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("GestionesSistema1");
        ...
        modelBuilder.Entity<InsertPlazosRespaldo>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Insert_PlazosRespaldo");
        ...
        modelBuilder.Entity<ProductividadAmex>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ProductividadAmex");

            entity.Property(e => e.AmountRelevantPayer)
                .HasMaxLength(1)
                .IsUnicode(false)
                .HasColumnName("Amount Relevant Payer");
            entity.Property(e => e.BalanceInicial)
                .HasColumnType("money")
                .HasColumnName("Balance inicial");
            entity.Property(e => e.Cartera)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.Ejecutivo)
            ...
            entity.Property(e => e.Encargado)
                ...
                .IsUnicode(false)
                .UseCollation("Modern_Spanish_BIN2");
            entity.Property(e => e.Entre1Y3Minutos).HasColumnName("Entre 1 y 3 minutos");
            entity.Property(e => e.Epay).HasColumnType("money");
            entity.Property(e => e.HoraIngresoSistema).HasPrecision(0);
            entity.Property(e => e.HoraPrimerGestión).HasPrecision(0);
            entity.Property(e => e.HoraSalidaSistema).HasPrecision(0);
            entity.Property(e => e.HoraÚltimaGestión).HasPrecision(0);
            entity.Property(e => e.IdEjecutivo).HasColumnName("idEjecutivo");
            entity.Property(e => e.MayorA3Minutos).HasColumnName("Mayor a 3 minutos");
            entity.Property(e => e.MenorA1Minuto).HasColumnName("Menor a 1 minuto");
            entity.Property(e => e.MontoNegociado).HasColumnType("money");
            entity.Property(e => e.MontoPagado).HasColumnType("money");
            entity.Property(e => e.Ngc).HasColumnName("NGC #");
            entity.Property(e => e.NgcAmount)
                .HasColumnType("money")
                .HasColumnName("NGC Amount");
            entity.Property(e => e.NombreEjecutivo)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.NombreEncargado)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.PagosRelevantes)
                .HasMaxLength(1)
                .IsUnicode(false)
                .HasColumnName("Pagos Relevantes #");
            ...
            entity.Property(e => e.TiempoCurso).HasPrecision(0);
            entity.Property(e => e.TiempoEnBúsqueda).HasPrecision(0);
            entity.Property(e => e.TiempoEnCuentas).HasPrecision(0);
            entity.Property(e => e.TiempoFallaTécnica).HasPrecision(0);
            entity.Property(e => e.TiempoPermiso).HasPrecision(0);
            entity.Property(e => e.TiempoSinContacto).HasPrecision(0);
        });
        ...
        modelBuilder.Entity<Prueba200>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Prueba_200");

            entity.HasIndex(e => new { e.IdCuenta, e.FechaInsert, e.SegundoInsert }, "IX_San200Temp").IsClustered();
        ...
        modelBuilder.Entity<San200>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("San200_");
