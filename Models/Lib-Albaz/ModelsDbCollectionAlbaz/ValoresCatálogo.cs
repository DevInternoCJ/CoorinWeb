...
public partial class ValoresCatálogo
{
    ...
    public virtual ICollection<BúsquedasV> BúsquedasVIdDatoNavigations { get; set; } = new List<BúsquedasV>();

    public virtual ICollection<BúsquedasV> BúsquedasVIdFuenteNavigations { get; set; } = new List<BúsquedasV>();

    public virtual ICollection<Búsquedum> BúsquedumIdDatoNavigations { get; set; } = new List<Búsquedum>();

    public virtual ICollection<Búsquedum> BúsquedumIdFuenteNavigations { get; set; } = new List<Búsquedum>();
