...
public partial class GestionesTelefónicasBackup
{
    ...
    public virtual ComentariosBackup ComentariosBackup { get; set; } = null!;

    public virtual CuentasBackup CuentasBackup { get; set; } = null!;

    public virtual GrabacionesIntegraciónBackup? GrabacionesIntegraciónBackup { get; set; }
    ...
    public virtual TeléfonosBackup? TeléfonosBackup { get; set; }
}
