...
namespace HadesLibrary.ModelsDbMemory;

public partial class DbMemoryContextHades : DbContext
{
    public DbMemoryContextHades()
    {
    }

    public DbMemoryContextHades(DbContextOptions<DbMemoryContextHades> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=192.168.7.7; database=dbMemory; uid=login_Allocation_Admin; pwd=Cannondale2015?; encrypt=true;trustservercertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdFilaDeTrabajo).HasName("PK__FilasDeT__87EEFA0A875E7F25");
        ...
        modelBuilder.Entity<GruposDeTrabajo>(entity =>
        {
            entity.HasKey(e => new { e.IdCampaña, e.IdEjecutivo })
                .HasName("PK__GruposDe__A423DC151828C938")
                .IsClustered(false);
        ...
        {
            entity.HasKey(e => new { e.IdEjecutivo, e.Hora })
                .HasName("PK__Producti__6731E36625AEEC53")
                .IsClustered(false);

            entity.ToTable("Productividad", "PS");
        ...
        {
            entity.HasKey(e => e.IdEjecutivo).HasName("PK__Sesiones__01E1027524A75A6A");
