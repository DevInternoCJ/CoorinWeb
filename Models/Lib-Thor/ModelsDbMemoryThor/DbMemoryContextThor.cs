...
namespace Loki.ModelsDbMemoryThor;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdFilaDeTrabajo).HasName("PK__FilasDeT__87EEFA0AB9A3ACC3");
        ...
        modelBuilder.Entity<GruposDeTrabajo>(entity =>
        {
            entity.HasKey(e => new { e.IdCampaña, e.IdEjecutivo })
                .HasName("PK__GruposDe__A423DC15A64D5357")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Productividad>(entity =>
        {
            entity.HasKey(e => new { e.IdEjecutivo, e.Hora })
                .HasName("PK__Producti__6731E366A61D78BC")
                .IsClustered(false);
        ...
        {
            entity.HasKey(e => e.IdEjecutivo).HasName("PK__Sesiones__01E10275FB087DED");
