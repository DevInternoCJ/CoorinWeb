...
public partial class Producto78
{
    ...
    public string? MaxDiasVencimiento { get; set; }
    ...
    public string? Capa0130 { get; set; }

    public string? Capa3160 { get; set; }

    public string? Capa6190 { get; set; }

    public string? Capa91120 { get; set; }

    public string? CapaMas120 { get; set; }
    ...
    public string? ConsumoFinal { get; set; }
    ...
    public string? Saldoaldíatotal { get; set; }

    public string? SaldoaldíaVencido { get; set; }
