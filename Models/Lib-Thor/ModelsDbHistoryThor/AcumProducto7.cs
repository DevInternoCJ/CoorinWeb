...
public partial class AcumProducto7
{
    ...
    public string? Trascodificada { get; set; }
    ...
    public string? PlazoPactado { get; set; }

    public string? Tasa { get; set; }

    public string? Mensualidad { get; set; }

    public string? FechaAltaRefin { get; set; }

    public string? OrigenRefin { get; set; }
    ...
    public string? DiasAsignacion { get; set; }

    public string? Clasif { get; set; }

    public string? CP { get; set; }

    public string? Lada11 { get; set; }

    public string? Tel11 { get; set; }

    public string? Lada21 { get; set; }

    public string? Tel21 { get; set; }

    public string? Lada31 { get; set; }

    public string? Tel31 { get; set; }

    public string? UltimoSaldoMesAnterior { get; set; }

    public string? Bhscor { get; set; }

    public string? Pv1mesAtras { get; set; }

    public string? Pv2mesAtras { get; set; }

    public string? Pv3mesAtras { get; set; }

    public string? Pv4mesAtras { get; set; }

    public string? Pv5mesAtras { get; set; }

    public string? Pv6mesAtras { get; set; }
    ...
    public string? FechaProxVencimiento { get; set; }
    ...
    public string? ContenciónCnet { get; set; }
    ...
    public string? ReviNómina { get; set; }
    ...
    public string? RangoDeSaldos { get; set; }
    ...
    public string? UnicoPago { get; set; }
    ...
    public string? Irreconsumo { get; set; }
    ...
    public string? Probabilida { get; set; }
    ...
    public string? AgenciaAnterior { get; set; }

    public string? FechaActualizacion { get; set; }

    public string? AgenciaConvenio { get; set; }

    public string? FechaProceso { get; set; }

    public string? Wk3mplct { get; set; }
}
