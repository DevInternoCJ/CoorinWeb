...
public partial class AcumProducto35
{
    ...
    public string? NumeroDeEstado { get; set; }
    ...
    public string? SaldoInicialDolares { get; set; }

    public string? SaldoVencido { get; set; }

    public string? SaldoVencidoDolares { get; set; }

    public string? InteresesFacturados { get; set; }

    public string? InteresesNoFacturados { get; set; }

    public string? SaldoActualDolares { get; set; }

    public string? SaldoAcobrar { get; set; }

    public string? SaldoAcobrarDolares { get; set; }

    public string? FechaAsigArchivo { get; set; }

    public string? FechaDeIngresoAcjc { get; set; }

    public string? FechaReasig { get; set; }

    public string? FechaActualizacion { get; set; }

    public string? FechaDevolucion { get; set; }

    public string? AcumuladoPagos { get; set; }

    public string? AcumuladoPagosDolares { get; set; }
    ...
    public string? FechaUltimaGestTel { get; set; }

    public string? ClaveUltimoGestTel { get; set; }

    public string? FechaSegGestTel { get; set; }

    public string? HoraSegGestTel { get; set; }

    public string? LlamadasCcontacto { get; set; }

    public string? LlamadasScontacto { get; set; }

    public string? StatusUltimaGestDom { get; set; }

    public string? FechaUltimaGestDom { get; set; }

    public string? ClaveUltimoGestDom { get; set; }

    public string? FechaSegGestDom { get; set; }

    public string? HoraSeguimGestDom { get; set; }

    public string? VisitasCcontacto { get; set; }

    public string? VisitasScontacto { get; set; }

    public string? NumRegistrosDatosNuevos { get; set; }

    public string? NumeroAvales { get; set; }
    ...
    public string? MarcadoParaHistorico { get; set; }

    public string? FechaActOper { get; set; }

    public string? FechaActMov { get; set; }
