...
public partial class ValoresCatálogo
{
    ...
    public virtual ICollection<Cuenta1> Cuenta1IdSituaciónNavigations { get; set; } = new List<Cuenta1>();

    public virtual ICollection<Cuenta1> Cuenta1IdSucursalNavigations { get; set; } = new List<Cuenta1>();
