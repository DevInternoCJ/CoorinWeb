...
public partial class AcumProducto125
{
    ...
    public string? FechReport { get; set; }

    public string? Status { get; set; }

    public string? Documentos { get; set; }

    public string? FechPoliza { get; set; }

    public string? FechOcurrencia { get; set; }
    ...
    public string? PrimaÚnica { get; set; }

    public string? FechaAperturaCuenta { get; set; }

    public string? FecEstatus { get; set; }
