...
public partial class DbMemoryContextMictlan : DbContext
{
    public DbMemoryContextMictlan()
    {
    }

    public DbMemoryContextMictlan(DbContextOptions<DbMemoryContextMictlan> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=192.168.7.197;database=dbMemory;uid=login_ejecutor;pwd=3j3123/*-;encrypt=true;trustservercertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdFilaDeTrabajo).HasName("PK__FilasDeT__87EEFA0A1330783C");
        ...
        modelBuilder.Entity<GruposDeTrabajo>(entity =>
        {
            entity.HasKey(e => new { e.IdCampaña, e.IdEjecutivo })
                .HasName("PK__GruposDe__A423DC15C445C1C3")
                .IsClustered(false);
        ...
        {
            entity.HasKey(e => new { e.IdEjecutivo, e.Hora }).HasName("PK__Producti__6731E366ADF1A7A7");
        ...
        {
            entity.HasKey(e => e.IdEjecutivo).HasName("PK__Sesiones__01E10275CA37B98A");
