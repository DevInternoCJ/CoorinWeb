...
public partial class Producto1
{
    ...
    public string Valajuste { get; set; } = null!;

    public string Fases { get; set; } = null!;
    ...
    public string? Rmsacctnum { get; set; }

    public string? Rmsamount { get; set; }

    public string? Rmsloancd { get; set; }

    public string? Rmsrecvrcd { get; set; }
