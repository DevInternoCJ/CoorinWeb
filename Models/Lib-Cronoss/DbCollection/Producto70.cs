...
public partial class Producto70
{
    ...
    public string? VenVeNombreCompleto { get; set; }

    public string? FormaPago { get; set; }

    public string? RegionSaeo { get; set; }
    ...
    public string? ReferenciaBanorte { get; set; }

    public string? ReferenciaBaz { get; set; }

    public string? ReferenciaHsbc { get; set; }

    public string? ReferenciaSantander { get; set; }
