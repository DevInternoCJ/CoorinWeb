...
namespace Loki.DbMemory.ModelsCronoss;

public partial class DbMemoryContextCronoss : DbContext
{
    public DbMemoryContextCronoss()
    {
    }

    public DbMemoryContextCronoss(DbContextOptions<DbMemoryContextCronoss> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=192.168.7.65;database=dbMemory;uid=login_Ejecutor;pwd=3j3123/*-;encrypt=true;trustservercertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdFilaDeTrabajo).HasName("PK__FilasDeT__87EEFA0A9C48BD9F");
        ...
        modelBuilder.Entity<GruposDeTrabajo>(entity =>
        {
            entity.HasKey(e => new { e.IdCampaña, e.IdEjecutivo })
                .HasName("PK__GruposDe__A423DC1505BB1644")
                .IsClustered(false);
        ...
        {
            entity.HasKey(e => new { e.IdEjecutivo, e.Hora }).HasName("PK__Producti__6731E3665B80F78B");
        ...
        {
            entity.HasKey(e => e.IdEjecutivo).HasName("PK__Sesiones__01E10275002EF632");
