...
public partial class DbAllocationContextGaia : DbContext
{
    public DbAllocationContextGaia()
    {
    }

    public DbAllocationContextGaia(DbContextOptions<DbAllocationContextGaia> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<Doms31187140> Doms31187140s { get; set; }

    public virtual DbSet<Ejecucione> Ejecuciones { get; set; }

    public virtual DbSet<Extr31187149> Extr31187149s { get; set; }

    public virtual DbSet<Extr31187150> Extr31187150s { get; set; }

    public virtual DbSet<Extr31187151> Extr31187151s { get; set; }
    ...
    public virtual DbSet<Mail31187142Pivot> Mail31187142Pivots { get; set; }

    public virtual DbSet<MailProducto3102977> MailProducto3102977s { get; set; }

    public virtual DbSet<MailProducto4102981> MailProducto4102981s { get; set; }

    public virtual DbSet<MailProducto4102983> MailProducto4102983s { get; set; }
    ...
    public virtual DbSet<Tels31187141Pivot> Tels31187141Pivots { get; set; }

    public virtual DbSet<TelsProducto2102972> TelsProducto2102972s { get; set; }

    public virtual DbSet<TelsProducto2102974> TelsProducto2102974s { get; set; }

    public virtual DbSet<TelsProducto28102984> TelsProducto28102984s { get; set; }

    public virtual DbSet<TelsProducto3102976> TelsProducto3102976s { get; set; }

    public virtual DbSet<TelsProducto3102978> TelsProducto3102978s { get; set; }

    public virtual DbSet<TelsProducto4102980> TelsProducto4102980s { get; set; }

    public virtual DbSet<TelsProducto4102982> TelsProducto4102982s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Doms31187140>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("DOMS_31_187140", "Temp");
        ...
        modelBuilder.Entity<Extr31187149>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("EXTR_31_187149", "Temp");
            ...
            entity.Property(e => e.IdCuenta)
                ...
                .UseCollation("Modern_Spanish_BIN2")
                .HasColumnName("idCuenta");
            entity.Property(e => e.MontoMenorSolicitadoRenego12op1)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("MontoMenorSolicitado_Renego_12OP1");
            entity.Property(e => e.MontoMenorSolicitadoRenego12op2)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("MontoMenorSolicitado_Renego_12OP2");
            entity.Property(e => e.MontoMenorSolicitadoRenego20op1)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("MontoMenorSolicitado_Renego_20OP1");
            entity.Property(e => e.MontoMenorSolicitadoRenego20op2)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("MontoMenorSolicitado_Renego_20OP2");
            entity.Property(e => e.PlazoRenegociaciones1)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Plazo_Renegociaciones1");
            entity.Property(e => e.PlazoRenegociaciones2)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Plazo_Renegociaciones2");
            entity.Property(e => e.ProductoRenegociadoOp1)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Producto_Renegociado_OP_1");
            entity.Property(e => e.ProductoRenegociadoOp2)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Producto_Renegociado_OP_2");
            entity.Property(e => e.RenegociacionMensual12mopc1)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Renegociacion_Mensual_12MOPC1");
            entity.Property(e => e.RenegociacionMensual12mopc2)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Renegociacion_Mensual_12MOPC2");
            entity.Property(e => e.RenegociacionMensual20mopc1)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Renegociacion_Mensual_20MOPC1");
            entity.Property(e => e.SuceptRenegociaciones)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Sucept_Renegociaciones");
            entity.Property(e => e.TasaMensualRenegociaciones)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Tasa_Mensual_Renegociaciones");
            entity.Property(e => e.TasaRenegociaciones)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Tasa_Renegociaciones");
        ...
        modelBuilder.Entity<Extr31187150>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("EXTR_31_187150", "Temp");
        ...
        modelBuilder.Entity<Extr31187151>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("EXTR_31_187151", "Temp");
        ...
        modelBuilder.Entity<Mail31187142Pivot>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("MAIL_31_187142_Pivot", "Temp");
        ...
        modelBuilder.Entity<MailProducto3102977>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("MAIL_Producto_3_102977", "Temp");
        ...
        modelBuilder.Entity<MailProducto4102981>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("MAIL_Producto_4_102981", "Temp");
        ...
        modelBuilder.Entity<MailProducto4102983>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("MAIL_Producto_4_102983", "Temp");
        ...
        modelBuilder.Entity<Tels31187141Pivot>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("TELS_31_187141_Pivot", "Temp");
        ...
        modelBuilder.Entity<TelsProducto2102972>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("TELS_Producto_2_102972", "Temp");
        ...
        modelBuilder.Entity<TelsProducto2102974>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("TELS_Producto_2_102974", "Temp");
        ...
        modelBuilder.Entity<TelsProducto28102984>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("TELS_Producto_28_102984", "Temp");
        ...
        modelBuilder.Entity<TelsProducto3102976>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("TELS_Producto_3_102976", "Temp");
        ...
        modelBuilder.Entity<TelsProducto3102978>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("TELS_Producto_3_102978", "Temp");
        ...
        modelBuilder.Entity<TelsProducto4102980>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("TELS_Producto_4_102980", "Temp");
        ...
        modelBuilder.Entity<TelsProducto4102982>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("TELS_Producto_4_102982", "Temp");
