...
namespace GaiaLibrary.ModelsDbMemory;

public partial class DbMemoryContextGaia : DbContext
{
    public DbMemoryContextGaia()
    {
    }

    public DbMemoryContextGaia(DbContextOptions<DbMemoryContextGaia> options)
        : base(options)
    {
    }
