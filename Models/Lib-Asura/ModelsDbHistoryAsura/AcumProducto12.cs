...
public partial class AcumProducto12
{
    ...
    public string? EjecNvaZona { get; set; }
    ...
    public string? DrAntigua { get; set; }

    public string? Hoy1 { get; set; }

    public string? MorosidadRespectoADrAntigua { get; set; }

    public string? CapitalDeRiesgo { get; set; }

    public string? FechaDeÚltimoPagoRealizado { get; set; }

    public string? ImporteDeÚltimoPagoRealizado { get; set; }
    ...
    public string? AutoSerie { get; set; }
    ...
    public string? FechaDeVtoDelCto { get; set; }

    public string? InicioCto { get; set; }

    public string? ObligadoSolidario { get; set; }

    public string? Plazo { get; set; }

    public string? ReferenciaPago { get; set; }

    public string? VtoCto { get; set; }
    ...
    public string? PrefPaymentDate { get; set; }

    public string? CamFirstFaxNumber { get; set; }

    public string? Observaciones { get; set; }

    public string? Uber { get; set; }

    public string? CarpetaDeHoy { get; set; }

    public string? AgenciaAyer { get; set; }

    public string? AgenciaHoy { get; set; }
    ...
    public string? CarpetaAlta { get; set; }

    public string? FechaAsignaciónAgencia { get; set; }

    public string? ComportamientoDePago { get; set; }

    public string? DigitoVerificador { get; set; }

    public string? Estado { get; set; }

    public string? CarpetaAnterior { get; set; }

    public string? CarpetaDeAyer { get; set; }

    public string? FacturaMasAntigua { get; set; }
    ...
    public string? ImporteUltimoPago { get; set; }

    public string? LoJack { get; set; }

    public string? CndRetail { get; set; }

    public string? Riesgo1 { get; set; }

    public string? CuentaACobrar { get; set; }
    ...
    public string? RentaFueraDeContrato { get; set; }

    public string? CargoPorTenencias { get; set; }
    ...
    public string? OtrosAdeudos { get; set; }

    public string? ControlVehicular { get; set; }

    public string? Mensualidades { get; set; }

    public string? RentaFueraDeContrato1 { get; set; }

    public string? PagoCliente { get; set; }

    public string? IvaComplement { get; set; }

    public string? NotaDeCreito { get; set; }

    public string? PagoDelCliente { get; set; }

    public string? DocumentoAbACargo { get; set; }

    public string? ChequeDevuelto { get; set; }

    public string? ReclasificacionACargo { get; set; }

    public string? CargosDiversos { get; set; }

    public string? RenovacionDeSeguros { get; set; }

    public string? Mensualidad { get; set; }

    public string? GastosDeCobranza { get; set; }

    public string? Fotoinfracciones { get; set; }

    public string? Tenencias { get; set; }

    public string? Moratorios { get; set; }

    public string? PagoIncial { get; set; }

    public string? CarteraPorCobrar { get; set; }

    public string? RiesgoDeTraspaso { get; set; }

    public string? TraspasoALegal { get; set; }

    public string? RfSeguro { get; set; }

    public string? AutoFacturado { get; set; }

    public string? PagoInicialAFavor { get; set; }

    public string? TraspasoLegal { get; set; }

    public string? Equipo { get; set; }

    public string? TraspasoLegalActualizado { get; set; }

    public string? CarpetaHoy { get; set; }

    public string? CuentaPoCobrar { get; set; }

    public string? Baja { get; set; }

    public string? AgenciaDeHoy { get; set; }
    ...
    public string? TipoDeAsigMedio { get; set; }

    public string? DiasFaltantes { get; set; }

    public string? FechaDeTraspaso { get; set; }

    public string? Tipo { get; set; }

    public string? Riesgo11 { get; set; }
    ...
    public string? PaymentBehavior35 { get; set; }

    public string? AutoNuevoUsado { get; set; }

    public string? Contratos { get; set; }

    public string? CreditPagoFinalVencido { get; set; }

    public string? PagoFinal { get; set; }

    public string? UnidadGespa { get; set; }

    public string? CntActivationDate56 { get; set; }

    public string? CompanySActivities26 { get; set; }

    public string? CustomerGroup10 { get; set; }

    public string? DevolutionDate49 { get; set; }

    public string? FirstAnnuityDate54 { get; set; }

    public string? PositionOfBp27 { get; set; }

    public string? StatusReason55 { get; set; }

    public string? Term45 { get; set; }

    public string? TipoDeContratoC0lBr64 { get; set; }

    public string? UserStatus48 { get; set; }
    ...
    public string? VauSi { get; set; }

    public string? FechaParaRefinaciar { get; set; }

    public string? Minimo { get; set; }

    public string? DcContrato1 { get; set; }
    ...
    public string? RiesgoSap { get; set; }

    public string? Regplg { get; set; }

    public string? FormaDePago { get; set; }

    public string? RespuestaBancaria { get; set; }

    public string? Refinanciamiento { get; set; }

    public string? SiniestroSinDocumentar { get; set; }

    public string? Rango { get; set; }

    public string? Cont { get; set; }

    public string? MalaIntención { get; set; }

    public string? Pb { get; set; }

    public string? PlanCovid { get; set; }

    public string? ContObservaciones { get; set; }

    public string? TipoDeAsig { get; set; }

    public string? SaldoAFavorAb { get; set; }

    public string? NotaDeCreditoDg { get; set; }

    public string? PagoDelClienteDz { get; set; }

    public string? CargosDiversosDo { get; set; }

    public string? RenovacionDeSegurosDc { get; set; }

    public string? MensualidadDr { get; set; }

    public string? PagoProgramadoDl { get; set; }

    public string? RentaFueraDeContratoDy { get; set; }

    public string? GastosDeCobranzaD7 { get; set; }

    public string? FotoinfraccionesD8 { get; set; }

    public string? TenenciasD9 { get; set; }

    public string? ControlVehicularDq { get; set; }

    public string? IvaComplementSk { get; set; }

    public string? MoratoriosC1 { get; set; }

    public string? PagoIncialDi { get; set; }

    public string? AutoFacturadoDa { get; set; }

    public string? RfSeguroE1 { get; set; }

    public string? PagoInicialAFavorK2 { get; set; }

    public string? C { get; set; }

    public string? EjecutivoGestion { get; set; }
