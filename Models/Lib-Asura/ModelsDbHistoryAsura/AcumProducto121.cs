...
public partial class AcumProducto121
{
    ...
    public string? FechaRetito { get; set; }
    ...
    public string? UltimoContactoEfectivo { get; set; }
    ...
    public string? BonDosPagos { get; set; }
