...
public partial class Producto150
{
    ...
    public string? DescuentoMaximoAutorizado { get; set; }

    public string? SaldoTotal { get; set; }

    public string? PrecioLibroAzulALaCompra { get; set; }

    public string? EstatusEnSistema { get; set; }

    public string? TitularYOAval { get; set; }

    public string? MontoParaCalculo { get; set; }

    public string? DescuentoConvenio { get; set; }

    public string? PagoConvenido { get; set; }

    public string? FechaCaducidadConvenio { get; set; }

    public string? BitacoraDespacho { get; set; }
}
