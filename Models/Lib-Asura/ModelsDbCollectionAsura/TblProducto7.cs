...
public partial class TblProducto7
{
    public string? Consecutivo { get; set; }

    public byte[]? Idcuenta { get; set; }

    public byte[]? NombreCliente { get; set; }
    ...
    public byte[]? CalleNoCliente { get; set; }

    public byte[]? ColoniaCliente { get; set; }

    public byte[]? CiudadCliente { get; set; }

    public byte[]? Estado { get; set; }

    public byte[]? CodPostal { get; set; }

    public byte[]? Lada1 { get; set; }

    public byte[]? Tel1 { get; set; }

    public byte[]? Lada2 { get; set; }

    public byte[]? Tel2 { get; set; }

    public byte[]? Lada3 { get; set; }
