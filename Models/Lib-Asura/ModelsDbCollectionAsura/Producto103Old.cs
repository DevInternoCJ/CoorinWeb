...
public partial class Producto103Old
{
    ...
    public string? ObservacionesSolicitudDePagare { get; set; }

    public string? SegundaVuelta { get; set; }

    public string? Substatus { get; set; }

    public string? RetailLeasing { get; set; }

    public string? PreWOff { get; set; }
    ...
    public string? DescuentoMinimoParaLiquidación { get; set; }

    public string? Beneficio { get; set; }

    public string? Relacionadas { get; set; }
    ...
    public string? DescuentoMinimoParaLiquidación1 { get; set; }
}
