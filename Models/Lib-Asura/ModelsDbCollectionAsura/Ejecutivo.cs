...
public partial class Ejecutivo
{
    ...
    public virtual ICollection<CondonacionNeg> CondonacionNegs { get; set; } = new List<CondonacionNeg>();
    ...
    public virtual ICollection<CorreosEnviados3> CorreosEnviados3s { get; set; } = new List<CorreosEnviados3>();
    ...
    public virtual ICollection<Cuentas5> Cuentas5IdEjecutivoÚltimaGestiónNavigations { get; set; } = new List<Cuentas5>();

    public virtual ICollection<Cuentas5> Cuentas5IdEjecutivoÚltimaNegociaciónNavigations { get; set; } = new List<Cuentas5>();

    public virtual ICollection<Cuentas5> Cuentas5IdEjecutivoÚltimaVisitaNavigations { get; set; } = new List<Cuentas5>();
