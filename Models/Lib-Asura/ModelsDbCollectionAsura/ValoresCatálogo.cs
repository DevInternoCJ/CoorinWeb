...
public partial class ValoresCatálogo
{
    ...
    public virtual ICollection<Cuentas5> Cuentas5IdCausaNoPagoNavigations { get; set; } = new List<Cuentas5>();

    public virtual ICollection<Cuentas5> Cuentas5IdSituaciónNavigations { get; set; } = new List<Cuentas5>();

    public virtual ICollection<Cuentas5> Cuentas5IdSucursalNavigations { get; set; } = new List<Cuentas5>();
