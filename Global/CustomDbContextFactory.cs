	...
	public class CustomDbContextFactory : IDbContextFactory
	{
		...
		public DbContext GetDbContext(string servidor, string tipoBase)
		{
			...
			return key switch
			{
				...
				"orochi_allocation" => _serviceProvider.GetRequiredService<DbAllocationContextOrochi>(),
				"orochi_collection" => _serviceProvider.GetRequiredService<DbCollectionContextOrochi>(),
				"orochi_history" => _serviceProvider.GetRequiredService<DbHistoryContextOrochi>(),
				"orochi_memory" => _serviceProvider.GetRequiredService<DbMemoryContextOrochi>(),
				...
				"albaz_complemento" => _serviceProvider.GetRequiredService<DbComplementoContextAlbaz>(),
